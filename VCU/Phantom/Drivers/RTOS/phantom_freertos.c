...
bool APPS2_RANGE_FAULT_TIMER_EXPIRED;   //added by jaypacamarra
bool BSE_RANGE_FAULT_TIMER_EXPIRED;     //added by jaypacamarra
bool FP_DIFF_FAULT_TIMER_EXPIRED;       //added by jaypacamarra
